...
namespace ToolGood.Words
{
    /*public class PinYinSearch
    {
        ...
        public PinYinSearch():this(PinYinSearchType.PinYin){}
        public PinYinSearch(PinYinSearchType type)
        {
            _type = type;
        }
        #endregion
        ...
        public List<string> SearchTexts(string text){ SearchTexts(text,false);}
        /// <summary>
        /// 搜索关键字
        /// </summary>
        ...
        /// <returns></returns>
        public List<string> SearchTexts(string text, bool keywordSort)
        {
            TextLine line;
        ...
        public List<int> SearchIds(string text){ SearchIds(text,false);}
        /// <summary>
        /// 搜索IDs
        /// </summary>
        /// <param name="text">文本</param>
        /// <param name="keywordSort">是否按拼音排序</param>
        /// <returns></returns>
        public List<int> SearchIds(string text, bool keywordSort)
        {
            TextLine line;
            trySplitSearchText(text, out line);
            List<ChineseNode> nodes = matching(line);
        ...
        public List<PinYinSearchResult> SearchTextWithIds(string text){ SearchTextWithIds(text,false);}
        /// <summary>
        /// 搜索关键字和IDs
        /// </summary>
        /// <param name="text">文本</param>
        /// <param name="keywordSort">是否按拼音排序</param>
        /// <returns></returns>
        public List<PinYinSearchResult> SearchTextWithIds(string text, bool keywordSort)
        {
            TextLine line;
            trySplitSearchText(text, out line);
            List<ChineseNode> nodes = matching(line);
        ...
        public List<string> PickTexts(string text){ PickTexts(text,false,2);}
        public List<string> PickTexts(string text,bool keywordSort){ PickTexts(text,keywordSort,2);}
        /// <summary>
        ...
        /// <returns></returns>
        public List<string> PickTexts(string text, bool keywordSort, int pickLength)
        {
            TextLine line;
            trySplitSearchText(text, out line);
            List<ChineseNode> nodes = matching(line);
        ...
        //重载模拟默认参数 解决CS0241 相当于.net4版本以上的public List<T> PickTextWithIds(string text,bool key = false,pickLength = 2)
        public List<PinYinSearchResult> PickTextWithIds(string text){ PickTextWithIds(text,false,2); }
        public List<PinYinSearchResult> PickTextWithIds(string text,bool keywordSort){ PickTextWithIds(text,ketwordSort,2); }
        /// <summary>
        ...
        /// <param name="pickLength">挑选长度</param>
        /// <returns></returns>
        public List<PinYinSearchResult> PickTextWithIds(string text, bool keywordSort, int pickLength)
        {
            TextLine line;
            trySplitSearchText(text, out line);
            List<ChineseNode> nodes = matching(line);
